<section class="section feature mb-0" id="feature">
  ...
  <img class="feature-bg-1 up-down-animation" src="assets/dtox-1.0.0/images/background-shape/feature-bg-1.png" alt="bg-shape">
  <img class="feature-bg-2 left-right-animation" src="assets/dtox-1.0.0/images/background-shape/feature-bg-2.png" alt="bg-shape">
</section>
