<section class="section-lg pb-0 pricing" id="pricing">
  ...
  <img class="pricing-bg-shape-2 up-down-animation" src="assets/dtox-1.0.0/images/background-shape/seo-half-cycle.png" alt="background-shape">
  <img class="pricing-bg-shape-3 left-right-animation" src="assets/dtox-1.0.0/images/background-shape/team-bg-triangle.png" alt="background-shape">
</section>
